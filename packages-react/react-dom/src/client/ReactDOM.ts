import { createEventHandle } from "@zenflux/react-dom-bindings/src/client/ReactDOMEventHandle";
import {
    batchedUpdates,
...
import { runWithPriority } from "@zenflux/react-reconciler/src/react-event-priorities";
import { createPortal as createPortalImpl } from "@zenflux/react-reconciler/src/react-portal";
...
} from "@zenflux/react-dom-bindings/src/events/ReactDOMControlledComponent";
...
import type { CreateRootOptions, HydrateRootOptions, RootType } from "./ReactDOMRoot";
...
export { useFormStatus, useFormState } from "@zenflux/react-dom-bindings/src/shared/ReactDOMFormActions";
...
function createPortal( children: ReactNodeList, container: Element | DocumentFragment, key: string | null | undefined = null ): React$Portal {
...
function renderSubtreeIntoContainer( parentComponent: React.Component<any, any>, element: React.ReactElement<React.ComponentProps<any>, any>, containerNode: Container, callback: ( ( ... args: Array<any> ) => any ) | null | undefined ): React.Component<any, any> | PublicInstance | null {
    return unstable_renderSubtreeIntoContainer( parentComponent, element, containerNode, callback );
}

function createRoot( container: Element | Document | DocumentFragment, options?: CreateRootOptions ): RootType {
    if ( __DEV__ ) {
...
function hydrateRoot( container: Document | Element, initialChildren: ReactNodeList, options?: HydrateRootOptions ): RootType {
    if ( __DEV__ ) {
        if ( ! Internals.usingClientEntryPoint && ! __UMD__ ) {
...
export {
    createPortal, batchedUpdates as unstable_batchedUpdates, flushSync, ReactVersion as version // Disabled behind disableLegacyReactDOMAPIs
    , findDOMNode, hydrate, render, unmountComponentAtNode // exposeConcurrentModeAPIs
    , createRoot, hydrateRoot // Disabled behind disableUnstableRenderSubtreeIntoContainer
