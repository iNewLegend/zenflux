    ...
    describe( 'interactive events, in concurrent mode', () => {
        ...
        it( 'flushes pending interactive work before exiting event handler', async () => {
            ...
            class Button extends React.Component {
                ...
                render() {
                    Scheduler.log( `render button: ${ this.state.disabled ? 'disabled' : 'enabled' }` );
                    return <button ref={ el => button = el } // Handler is removed after the first click
        ...
        it( 'end result of many interactive updates is deterministic', async () => {
            ...
            class Button extends React.Component {
                ...
                render() {
                    return <button ref={ el => button = el } onClick={ () => // Intentionally not using the updater form here
                        this.setState( {
