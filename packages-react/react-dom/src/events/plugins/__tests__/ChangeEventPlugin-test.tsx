...
describe( 'ChangeEventPlugin', () => {
    ...
    it( 'should not invoke a change event for textarea same value', () => {
        ...
        const node = ReactDOM.render( <textarea onChange={ cb } defaultValue="initial"/>, container );
        node.dispatchEvent( new Event( 'input', {
            bubbles: true,
            cancelable: true
        } ) );
    ...
    it( 'should not invoke a change event for textarea same value (capture)', () => {
        ...
        const node = ReactDOM.render( <textarea onChangeCapture={ cb } defaultValue="initial"/>, container );
        node.dispatchEvent( new Event( 'input', {
            bubbles: true,
            cancelable: true
        } ) );
    ...
    describe( 'concurrent mode', () => {
        it( 'text input', async () => {
            ...
            class ControlledInput extends React.Component {
                ...
                render() {
                    ...
                    return <input ref={ el => input = el } type="text" value={ controlledValue }
        ...
        it( 'checkbox input', async () => {
            ...
            class ControlledInput extends React.Component {
                ...
                render() {
                    ...
                    return <input ref={ el => input = el } type="checkbox" checked={ controlledValue }
                                  onChange={ this.onChange }/>;
                }
        ...
        it( 'textarea', async () => {
            ...
            class ControlledTextarea extends React.Component {
                ...
                render() {
                    Scheduler.log( `render: ${ this.state.value }` );
                    const controlledValue = this.state.value === 'changed' ? 'changed [!]' : this.state.value;
                    return <textarea ref={ el => textarea = el } type="text" value={ controlledValue }
                                     onChange={ this.onChange }/>;
                }
            ...
            class ControlledInput extends React.Component {
                ...
                render() {
                    ...
                    return <div onChange={ this.onChange }>
                        <input ref={ el => input = el } type="text" value={ controlledValue } onChange={ () => {// Does nothing. Parent handler is responsible for updating.
                        } }/>
                    </div>;
                }
        ...
        it( 'is sync for non-input events', async () => {
            ...
            class ControlledInput extends React.Component {
                ...
                render() {
                    ...
                    const controlledValue = this.state.value === 'changed' ? 'changed [!]' : this.state.value;
                    return <input ref={ el => input = el } type="text" value={ controlledValue }
                                  onChange={ this.onChange } onClick={ this.reset }/>;
                }
        ...
        it( 'mouse enter/leave should be user-blocking but not discrete', async () => {
            ...
            function Foo() {
                ...
                return <div ref={ target } onMouseEnter={ () => setHover( true ) }
