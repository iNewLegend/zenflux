...
function requestDeferredLane() {
    if ((0, react_fiber_work_in_progress_1.getWorkInProgressDeferredLane)() === react_fiber_lane_constants_1.NoLane) {
        ...
        var isPrerendering = (0, react_fiber_lane_1.includesSomeLane)((0, react_fiber_work_in_progress_1.getWorkInProgressRootRenderLanes)(), react_fiber_lane_constants_1.OffscreenLane) && !(0, react_fiber_hydration_is_hydrating_1.isHydrating)();
        if (isPrerendering) {
            // There's only one OffscreenLane, so if it contains deferred work, we
            // should just reschedule using the same lane.
            (0, react_fiber_work_in_progress_1.setWorkInProgressDeferredLane)(react_fiber_lane_constants_1.OffscreenLane);
        }
        else {
...
function requestUpdateLane(fiber) {
    ...
    else if ((0, react_fiber_work_excution_context_1.isExecutionContextRenderDeactivate)() && (0, react_fiber_work_in_progress_1.getWorkInProgressRootRenderLanes)() !== react_fiber_lane_constants_1.NoLanes) {
    ...
    if (isTransition) {
        ...
        return actionScopeLane !== react_fiber_lane_constants_1.NoLane ? // We're inside an async action scope. Reuse the same lane.
    ...
    if (updateLane !== react_fiber_lane_constants_1.NoLane) {
        return updateLane;
    }
