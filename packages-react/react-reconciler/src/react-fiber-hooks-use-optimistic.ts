...
import { NoLane, NoLanes, SyncLane } from "@zenflux/react-reconciler/src/react-fiber-lane-constants";
...
import type { Hook, Update, UpdateQueue } from "@zenflux/react-reconciler/src/react-fiber-hooks-types";
...
export function dispatchOptimisticSetState<S, A>( fiber: Fiber, throwIfDuringRender: boolean, queue: UpdateQueue<S, A>, action: A ): void {
    if ( __DEV__ ) {
