...
import * as domConfig from "@zenflux/react-dom-bindings/src/client/ReactFiberConfigDOM";
...
class ReactFiberConfig implements ReactReconcilerConfig {
    ...
    private getSupportSwitches( config: ReactReconcilerConfig ): ReactFiberConfigSupportsSwitches {
        const result: ReactFiberConfigSupportsSwitches = {} as any;

        for ( const key of ReactFiberConfigSupportsSwitchesMethods ) {
