...
function pushStoreConsistencyCheck(fiber, getSnapshot, renderedSnapshot) {
    fiber.flags |= react_fiber_flags_1.StoreConsistency;
    var check = {
...
function mountSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (_isHydrating) {
        ...
        if (!(0, react_fiber_lane_constants_1.includesBlockingLane)(root, rootRenderLanes)) {
    ...
    fiber.flags |= react_fiber_flags_1.Passive;
    (0, react_fiber_hooks_use_effect_1.pushEffect)(react_hook_effect_tags_1.HasEffect | react_hook_effect_tags_1.Passive, updateStoreInstance.bind(null, fiber, inst, nextSnapshot, getSnapshot), (0, react_fiber_hooks_use_effect_1.createEffectInstance)(), null);
    return nextSnapshot;
}
...
function updateSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (inst.getSnapshot !== getSnapshot || snapshotChanged || // Check if the subscribe function changed. We can save some memory by
        ...
        react_fiber_hooks_shared_1.ReactFiberHooksCurrent.workInProgressHook !== null && react_fiber_hooks_shared_1.ReactFiberHooksCurrent.workInProgressHook.memoizedState.tag & react_hook_effect_tags_1.HasEffect) {
        fiber.flags |= react_fiber_flags_1.Passive;
        (0, react_fiber_hooks_use_effect_1.pushEffect)(react_hook_effect_tags_1.HasEffect | react_hook_effect_tags_1.Passive, updateStoreInstance.bind(null, fiber, inst, nextSnapshot, getSnapshot), (0, react_fiber_hooks_use_effect_1.createEffectInstance)(), null);
        // Unless we're rendering a blocking lane, schedule a consistency check.
        // Right before committing, we will walk the tree and check if any of the
        ...
        if (!_isHydrating && !(0, react_fiber_lane_constants_1.includesBlockingLane)(root, react_fiber_hooks_shared_1.ReactFiberHooksCurrent.renderLanes)) {
            pushStoreConsistencyCheck(fiber, getSnapshot, nextSnapshot);
        }
    }
    return nextSnapshot;
