...
import type { BasicStateAction, UpdateQueue } from "@zenflux/react-reconciler/src/react-fiber-hooks-types";
...
export function startTransition<S>( fiber: Fiber, queue: UpdateQueue<S | Thenable<S>, BasicStateAction<S | Thenable<S>>>, pendingState: S, finishedState: S, callback: () => unknown, options?: StartTransitionOptions ): void {
