import { SyncLane } from "@zenflux/react-reconciler/src/react-fiber-lane-constants";
...
import type { Update } from "@zenflux/react-reconciler/src/react-fiber-class-update-queue";
...
export function createRootErrorUpdate( fiber: Fiber, errorInfo: CapturedValue<unknown>, lane: Lane ): Update<unknown> {
...
export function createClassErrorUpdate( fiber: Fiber, errorInfo: CapturedValue<unknown>, lane: Lane ): Update<unknown> {
    const update = createUpdate( lane );
    update.tag = CaptureUpdate;
