...
function findHostInstanceWithWarning(component, methodName) {
    if (__DEV__) {
        ...
        if (hostFiber.mode & react_type_of_mode_1.StrictLegacyMode) {
            ...
            if (!react_fiber_reconciler_shared_dev_1.default.didWarnAboutFindNodeInStrictMode[componentName]) {
                ...
                try {
                    ...
                    if (fiber.mode & react_type_of_mode_1.StrictLegacyMode) {
...
function attemptSynchronousHydration(fiber) {
    switch (fiber.tag) {
        ...
        case react_work_tags_1.SuspenseComponent: {
            ...
            var retryLane = react_fiber_lane_constants_1.SyncLane;
...
function attemptContinuousHydration(fiber) {
    ...
    var lane = react_fiber_lane_constants_1.SelectiveHydrationLane;
...
if (__DEV__) {
    ...
    var copyWithRename_1 = function (obj, oldPath, newPath) {
        if (oldPath.length !== newPath.length) {
            ...
            for (var i_1 = 0; i_1 < newPath.length - 1; i_1++) {
                if (oldPath[i_1] !== newPath[i_1]) {
