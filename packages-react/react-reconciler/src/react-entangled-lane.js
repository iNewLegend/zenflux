...
exports.entangledRenderLanes = react_fiber_lane_constants_1.NoLanes;
...
function getEntangledLanes(root, renderLanes) {
    ...
    if (react_feature_flags_1.allowConcurrentByDefault && (root.current.mode & react_type_of_mode_1.ConcurrentUpdatesByDefaultMode) !== react_type_of_mode_1.NoMode) { // Do nothing, use the lanes as they were assigned.
    }
    else if ((entangledLanes & react_fiber_lane_constants_1.InputContinuousLane) !== react_fiber_lane_constants_1.NoLanes) {
        // When updates are sync by default, we entangle continuous priority updates
        // and default updates, so they render in the same batch. The only reason
        // they use separate lanes is because continuous updates should interrupt
        // transitions, but default updates should not.
        entangledLanes |= entangledLanes & react_fiber_lane_constants_1.DefaultLane;
    }
    ...
    if (allEntangledLanes !== react_fiber_lane_constants_1.NoLanes) {
