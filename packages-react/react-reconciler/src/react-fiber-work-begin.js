...
function updateForwardRef(current, workInProgress, Component, nextProps, renderLanes) {
    ...
    workInProgress.flags |= react_fiber_flags_1.PerformedWork;
...
function updateMemoComponent(current, workInProgress, Component, nextProps, renderLanes) {
    if (current === null) {
        ...
        if ((0, react_fiber_create_utils_1.isSimpleFunctionComponent)(type) && Component.compare === null && // SimpleMemoComponent codepath doesn't resolve outer props either.
            ...
            workInProgress.tag = react_work_tags_1.SimpleMemoComponent;
...
function updateSimpleMemoComponent(current, workInProgress, Component, nextProps, renderLanes) {
    ...
    if (current !== null) {
        ...
        __DEV__ ? workInProgress.type === current.type : true)) {
            ...
            else if ((current.flags & react_fiber_flags_1.ForceUpdateForLegacySuspense) !== react_fiber_flags_1.NoFlags) {
...
function updateOffscreenComponent(current, workInProgress, renderLanes) {
    ...
    var nextIsDetached = (workInProgress.stateNode._pendingVisibility & react_fiber_activity_component_1.OffscreenDetached) !== 0;
    ...
    if (nextProps.mode === "hidden" || react_feature_flags_1.enableLegacyHidden && nextProps.mode === "unstable-defer-without-hiding" || nextIsDetached) {
        ...
        var didSuspend = (workInProgress.flags & react_fiber_flags_1.DidCapture) !== react_fiber_flags_1.NoFlags;
        if (didSuspend) {
            ...
            if (current !== null) {
                ...
                var currentChildLanes = react_fiber_lane_constants_1.NoLanes;
                ...
                workInProgress.childLanes = react_fiber_lane_constants_1.NoLanes;
                workInProgress.child = null;
            }
            return deferHiddenOffscreenComponent(current, workInProgress, nextBaseLanes, renderLanes);
        }
        if ((workInProgress.mode & react_type_of_mode_1.ConcurrentMode) === react_type_of_mode_1.NoMode) {
            // In legacy sync mode, don't defer the subtree. Render it now.
            // TODO: Consider how Offscreen should work with transitions in the future
            var nextState = {
                baseLanes: react_fiber_lane_constants_1.NoLanes,
                cachePool: null
            };
        ...
        else if (!(0, react_fiber_lane_1.includesSomeLane)(renderLanes, react_fiber_lane_constants_1.OffscreenLane)) {
            // We're hidden, and we're not rendering at Offscreen. We will bail out
            // and resume this tree later.
            // Schedule this fiber to re-render at Offscreen priority
            workInProgress.lanes = workInProgress.childLanes = (0, react_fiber_lane_1.laneToLanes)(react_fiber_lane_constants_1.OffscreenLane);
            // Include the base lanes from the last render
            var nextBaseLanes = prevState !== null ? (0, react_fiber_lane_1.mergeLanes)(prevState.baseLanes, renderLanes) : renderLanes;
            return deferHiddenOffscreenComponent(current, workInProgress, nextBaseLanes, renderLanes);
        }
...
function updateCacheComponent(current, workInProgress, renderLanes) {
    ...
    if (current === null) {
        ...
        if (prevState.parent !== parentCache) {
            ...
            if (workInProgress.lanes === react_fiber_lane_constants_1.NoLanes) {
...
function markRef(current, workInProgress) {
    ...
    if (current === null && ref !== null || current !== null && current.ref !== ref) {
        ...
        workInProgress.flags |= react_fiber_flags_1.Ref;
        workInProgress.flags |= react_fiber_flags_1.RefStatic;
    }
}
    ...
    if (__DEV__) {
        ...
        switch ((0, react_fiber_should_error_1.shouldError)(workInProgress)) {
            ...
            case true: {
                ...
                workInProgress.flags |= react_fiber_flags_1.ShouldCapture;
...
function finishClassComponent(current, workInProgress, Component, shouldUpdate, hasContext, renderLanes) {
    ...
    markRef(current, workInProgress);
    var didCaptureError = (workInProgress.flags & react_fiber_flags_1.DidCapture) !== react_fiber_flags_1.NoFlags;
    ...
    if (didCaptureError && typeof Component.getDerivedStateFromError !== "function") {
        ...
        if (__DEV__) {
            ...
            if (react_feature_flags_1.debugRenderPhaseSideEffectsForStrictMode && workInProgress.mode & react_type_of_mode_1.StrictLegacyMode) {
    ...
    if (supportsHydration && prevState.isDehydrated) {
        ...
        if (workInProgress.flags & react_fiber_flags_1.ForceClientRender) {
            ...
            while (node) {
                ...
                node.flags = node.flags & ~react_fiber_flags_1.Placement | react_fiber_flags_1.Hydrating;
                node = node.sibling;
            }
        }
    }
...
function mountHostRootWithoutHydrating(current, workInProgress, nextChildren, renderLanes, recoverableError) {
    ...
    workInProgress.flags |= react_fiber_flags_1.ForceClientRender;
    reconcileChildren(current, workInProgress, nextChildren, renderLanes);
    return workInProgress.child;
}
function updateHostComponent(current, workInProgress, renderLanes) {
    ...
    if (isDirectTextChild) {
        ...
        workInProgress.flags |= react_fiber_flags_1.ContentReset;
    }
...
function mountIncompleteClassComponent(_current, workInProgress, Component, nextProps, renderLanes) {
    ...
    workInProgress.tag = react_work_tags_1.ClassComponent;
...
function mountIndeterminateComponent(_current, workInProgress, Component, renderLanes) {
    ...
    if (__DEV__) {
        ...
        if (workInProgress.mode & react_type_of_mode_1.StrictLegacyMode) {
    ...
    !react_feature_flags_1.disableModulePatternComponents && typeof value === "object" && value !== null && typeof value.render === "function" && value.$$typeof === undefined) {
        ...
        workInProgress.tag = react_work_tags_1.FunctionComponent;
        if (__DEV__) {
...
var SUSPENDED_MARKER = {
    dehydrated: null,
    treeContext: null,
    retryLane: react_fiber_lane_constants_1.NoLane
};
...
function mountSuspenseFallbackChildren(workInProgress, primaryChildren, fallbackChildren, renderLanes) {
    ...
    if ((mode & react_type_of_mode_1.ConcurrentMode) === react_type_of_mode_1.NoMode && progressedPrimaryFragment !== null) {
        // In legacy mode, we commit the primary tree as if it successfully
        // completed, even though it's in an inconsistent state.
        primaryChildFragment = progressedPrimaryFragment;
        primaryChildFragment.childLanes = react_fiber_lane_constants_1.NoLanes;
        primaryChildFragment.pendingProps = primaryChildProps;
        if (react_feature_flags_1.enableProfilerTimer && workInProgress.mode & react_type_of_mode_1.ProfileMode) {
        ...
        primaryChildFragment = mountWorkInProgressOffscreenFiber(primaryChildProps, mode, react_fiber_lane_constants_1.NoLanes);
        fallbackChildFragment = (0, react_fiber_1.createFiberFromFragment)(fallbackChildren, mode, renderLanes, null);
    }
    primaryChildFragment.return = workInProgress;
...
function mountWorkInProgressOffscreenFiber(offscreenProps, mode, renderLanes) {
    ...
    return (0, react_fiber_create_from_offscreen_1.createFiberFromOffscreen)(offscreenProps, mode, react_fiber_lane_constants_1.NoLanes, null);
}
...
function updateSuspensePrimaryChildren(current, workInProgress, primaryChildren, renderLanes) {
    ...
    if (currentFallbackChildFragment !== null) {
        ...
        if (deletions === null) {
            ...
            workInProgress.flags |= react_fiber_flags_1.ChildDeletion;
        }
        else {
...
function updateSuspenseFallbackChildren(current, workInProgress, primaryChildren, fallbackChildren, renderLanes) {
    ...
    // completed, even though it's in an inconsistent state.
    (mode & react_type_of_mode_1.ConcurrentMode) === react_type_of_mode_1.NoMode && // Make sure we're on the second pass, i.e. the primary child fragment was
        ...
        primaryChildFragment.subtreeFlags = currentPrimaryChildFragment.subtreeFlags & react_fiber_flags_1.StaticMask;
    }
    var fallbackChildFragment;
    if (currentFallbackChildFragment !== null) {
        ...
        fallbackChildFragment.flags |= react_fiber_flags_1.Placement;
    }
    fallbackChildFragment.return = workInProgress;
    primaryChildFragment.return = workInProgress;
    primaryChildFragment.sibling = fallbackChildFragment;
...
function retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes, recoverableError) {
    ...
    // Needs a placement effect because the parent (the Suspense boundary) already
    // mounted but this is a new fiber.
    primaryChildFragment.flags |= react_fiber_flags_1.Placement;
    workInProgress.memoizedState = null;
    return primaryChildFragment;
}
function mountSuspenseFallbackAfterRetryWithoutHydrating(current, workInProgress, primaryChildren, fallbackChildren, renderLanes) {
    ...
    var primaryChildFragment = mountWorkInProgressOffscreenFiber(primaryChildProps, fiberMode, react_fiber_lane_constants_1.NoLanes);
...
function mountDehydratedSuspenseComponent(workInProgress, suspenseInstance, renderLanes) {
    ...
    if ((workInProgress.mode & react_type_of_mode_1.ConcurrentMode) === react_type_of_mode_1.NoMode) {
        ...
        workInProgress.lanes = (0, react_fiber_lane_1.laneToLanes)(react_fiber_lane_constants_1.SyncLane);
    }
        ...
        workInProgress.lanes = (0, react_fiber_lane_1.laneToLanes)(react_fiber_lane_constants_1.DefaultHydrationLane);
    }
    else {
        // We'll continue hydrating the rest at offscreen priority since we'll already
        // be showing the right content coming from the server, it is no rush.
        workInProgress.lanes = (0, react_fiber_lane_1.laneToLanes)(react_fiber_lane_constants_1.OffscreenLane);
    }
    return null;
}
    ...
    if (!didSuspend) {
        ...
        if ((0, react_fiber_work_in_progress_receive_update_1.didWorkInProgressReceiveUpdate)() || hasContextChanged) {
            ...
            if (root !== null) {
                ...
                if (attemptHydrationAtLane !== react_fiber_lane_constants_1.NoLane && attemptHydrationAtLane !== suspenseState.retryLane) {
            ...
            // inserted into the React tree here. It just happens to not need DOM
            // mutations because it already exists.
            primaryChildFragment.flags |= react_fiber_flags_1.Hydrating;
            return primaryChildFragment;
        }
    }
    else {
...
function propagateSuspenseContextChange(workInProgress, firstChild, renderLanes) {
    ...
    while (node !== null) {
        ...
        else if (node.tag === react_work_tags_1.SuspenseListComponent) {
        ...
        if ((revealOrder === "forwards" || revealOrder === "backwards") && children !== undefined && children !== null && children !== false) {
            if (Array.isArray(children)) {
                for (var i_1 = 0; i_1 < children.length; i_1++) {
                    if (!validateSuspenseListNestedChild(children[i_1], i_1)) {
                        return;
                    }
                }
            }
                ...
                if (typeof iteratorFn === "function") {
                    ...
                    if (childrenIterator) {
                        ...
                        for (; !step.done; step = childrenIterator.next()) {
                            if (!validateSuspenseListNestedChild(step.value, i_2)) {
                                return;
                            }
                            i_2++;
                        }
...
function updateSuspenseListComponent(current, workInProgress, renderLanes) {
    ...
    if (shouldForceFallback) {
        ...
        var didSuspendBefore = current !== null && (current.flags & react_fiber_flags_1.DidCapture) !== react_fiber_flags_1.NoFlags;
        if (didSuspendBefore) {
...
function resetSuspendedCurrentOnMountInLegacyMode(current, workInProgress) {
    if ((workInProgress.mode & react_type_of_mode_1.ConcurrentMode) === react_type_of_mode_1.NoMode) {
        if (current !== null) {
            ...
            workInProgress.flags |= react_fiber_flags_1.Placement;
        }
    }
}
...
function remountFiber(current, oldWorkInProgress, newWorkInProgress) {
    if (__DEV__) {
        ...
        newWorkInProgress.flags |= react_fiber_flags_1.Placement;
...
function attemptEarlyBailoutIfNoScheduledUpdate(current, workInProgress, renderLanes) {
    ...
    switch (workInProgress.tag) {
        ...
        case react_work_tags_1.SuspenseListComponent: {
            var didSuspendBefore = (current.flags & react_fiber_flags_1.DidCapture) !== react_fiber_flags_1.NoFlags;
            var hasChildWork = (0, react_fiber_lane_1.includesSomeLane)(renderLanes, workInProgress.childLanes);
        ...
        case react_work_tags_1.LegacyHiddenComponent: {
            ...
            // but I won't :)
            workInProgress.lanes = react_fiber_lane_constants_1.NoLanes;
    ...
    if (current !== null) {
        ...
        __DEV__ ? workInProgress.type !== current.type : false)) {
            ...
            if (!hasScheduledUpdateOrContext && // If this is the second pass of an error or suspense boundary, there
                ...
                (workInProgress.flags & react_fiber_flags_1.DidCapture) === react_fiber_flags_1.NoFlags) {
                // No pending updates or context. Bail out now.
                (0, react_fiber_work_in_progress_receive_update_1.markWorkInProgressReceivedUpdate)();
                return attemptEarlyBailoutIfNoScheduledUpdate(current, workInProgress, renderLanes);
            }
            if ((current.flags & react_fiber_flags_1.ForceUpdateForLegacySuspense) !== react_fiber_flags_1.NoFlags) {
                // This is a special case that only exists for legacy mode.
                // See https://github.com/facebook/react/pull/19216.
                (0, react_fiber_work_in_progress_receive_update_1.markWorkInProgressReceivedUpdate)();
            }
