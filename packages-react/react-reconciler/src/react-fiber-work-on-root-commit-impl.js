...
function commitRootImpl(root, recoverableErrors, transitions, renderPriorityLevel, spawnedLane) {
    ...
    if (finishedWork === null) {
        ...
        if (__DEV__) {
            if (lanes === react_fiber_lane_constants_1.NoLanes) {
                console.error("root.finishedLanes should not be empty during a commit. This is a " + "bug in React.");
            }
        }
    }
    root.finishedWork = null;
    root.finishedLanes = react_fiber_lane_constants_1.NoLanes;
    ...
    root.callbackPriority = react_fiber_lane_constants_1.NoLane;
    ...
    if (root === (0, react_fiber_work_in_progress_1.getWorkInProgressRoot)()) {
        ...
        (0, react_fiber_work_in_progress_1.setWorkInProgressRootRenderLanes)(react_fiber_lane_constants_1.NoLanes);
    }
    ...
    // They're redundant.
    if ((finishedWork.subtreeFlags & react_fiber_flags_1.PassiveMask) !== react_fiber_flags_1.NoFlags || (finishedWork.flags & react_fiber_flags_1.PassiveMask) !== react_fiber_flags_1.NoFlags) {
    ...
    var subtreeHasEffects = (finishedWork.subtreeFlags & (react_fiber_flags_1.BeforeMutationMask | react_fiber_flags_1.MutationMask | react_fiber_flags_1.LayoutMask | react_fiber_flags_1.PassiveMask)) !== react_fiber_flags_1.NoFlags;
    var rootHasEffect = (finishedWork.flags & (react_fiber_flags_1.BeforeMutationMask | react_fiber_flags_1.MutationMask | react_fiber_flags_1.LayoutMask | react_fiber_flags_1.PassiveMask)) !== react_fiber_flags_1.NoFlags;
    ...
    if (remainingLanes === react_fiber_lane_constants_1.NoLanes) {
    ...
    if (recoverableErrors !== null) {
        ...
        for (var i_1 = 0; i_1 < recoverableErrors.length; i_1++) {
            var recoverableError = recoverableErrors[i_1];
    ...
    // are consolidated.
    if ((0, react_fiber_lane_constants_1.includesSyncLane)((0, react_fiber_work_passive_effects_1.getPendingPassiveEffectsLanes)()) && root.tag !== react_root_tags_1.LegacyRoot) {
        (0, react_fiber_work_passive_effects_1.flushPassiveEffects)();
    }
    ...
    (0, react_fiber_lane_1.includesSomeLane)(lanes, react_fiber_lane_constants_1.UpdateLanes) && // Did it schedule a sync update?
        (0, react_fiber_lane_1.includesSomeLane)(remainingLanes, react_fiber_lane_constants_1.SyncUpdateLanes)) {
