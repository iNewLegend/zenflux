...
function shouldRemainOnPreviousScreen() {
    ...
    // just on this one.
    if ((0, react_fiber_lane_constants_1.includesOnlyTransitions)((0, react_fiber_work_in_progress_1.getWorkInProgressRootRenderLanes)())) {
    ...
    if ((0, react_fiber_lane_constants_1.includesOnlyRetries)((0, react_fiber_work_in_progress_1.getWorkInProgressRootRenderLanes)())
        || // In this context, an OffscreenLane counts as a Retry
            // TODO: It's become increasingly clear that Retries and Offscreen are
            // deeply connected. They probably can be unified further.
            (0, react_fiber_lane_1.includesSomeLane)((0, react_entangled_lane_1.getEntangledRenderLanes)(), react_fiber_lane_constants_1.OffscreenLane)) {
