...
var react_feature_flags_www_1 = require("@zenflux/react-shared/src/forks/react-feature-flags.www");
...
tag, hydrate, identifierPrefix, onRecoverableError, formState) {
    ...
    self.callbackPriority = react_fiber_lane_constants_1.NoLane;
    self.expirationTimes = (0, react_fiber_lane_1.createLaneMap)(react_fiber_lane_1.NoTimestamp);
    self.pendingLanes = react_fiber_lane_constants_1.NoLanes;
    self.suspendedLanes = react_fiber_lane_constants_1.NoLanes;
    self.pingedLanes = react_fiber_lane_constants_1.NoLanes;
    self.expiredLanes = react_fiber_lane_constants_1.NoLanes;
    self.finishedLanes = react_fiber_lane_constants_1.NoLanes;
    self.errorRecoveryDisabledLanes = react_fiber_lane_constants_1.NoLanes;
    self.shellSuspendCounter = 0;
    self.entangledLanes = react_fiber_lane_constants_1.NoLanes;
    self.entanglements = (0, react_fiber_lane_1.createLaneMap)(react_fiber_lane_constants_1.NoLanes);
    ...
    if (react_feature_flags_1.enableCache) {
        ...
        self.pooledCacheLanes = react_fiber_lane_constants_1.NoLanes;
    }
    ...
    // TODO: Something is wrong here
    if (react_feature_flags_www_1.enableUpdaterTracking) {
    ...
    if (__DEV__) {
        switch (tag) {
            case react_root_tags_1.ConcurrentRoot:
                self._debugRootType = hydrate ? "hydrateRoot()" : "createRoot()";
                break;
            case react_root_tags_1.LegacyRoot:
