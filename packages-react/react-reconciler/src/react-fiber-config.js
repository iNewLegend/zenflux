...
var domConfig = require("@zenflux/react-dom-bindings/src/client/ReactFiberConfigDOM");
// -------------------
//      BaseConfig
// -------------------
...
var ReactFiberConfig = /** @class */ (function () {
    ...
    ReactFiberConfig.prototype.getSupportSwitches = function (config) {
        var result = {};
        for (var _i = 0, ReactFiberConfigSupportsSwitchesMethods_2 = ReactFiberConfigSupportsSwitchesMethods; _i < ReactFiberConfigSupportsSwitchesMethods_2.length; _i++) {
            var key = ReactFiberConfigSupportsSwitchesMethods_2[_i];
