...
function resetSuspendedComponent(sourceFiber, rootRenderLanes) {
    ...
    if ((sourceFiber.mode & react_type_of_mode_1.ConcurrentMode) === react_type_of_mode_1.NoMode && (tag === react_work_tags_1.FunctionComponent || tag === react_work_tags_1.ForwardRef || tag === react_work_tags_1.SimpleMemoComponent)) {
...
function throwException(root, returnFiber, sourceFiber, value, rootRenderLanes) {
    ...
    sourceFiber.flags |= react_fiber_flags_1.Incomplete;
    ...
    if (value !== null && typeof value === "object") {
        ...
        if (typeof value.then === "function") {
            ...
            if (__DEV__) {
                if ((0, react_fiber_hydration_is_hydrating_1.isHydrating)() && sourceFiber.mode & react_type_of_mode_1.ConcurrentMode) {
                    (0, react_fiber_hydration_did_suspend_on_error_1.markDidThrowWhileHydratingDEV)();
                }
            }
            if (__DEV__) {
                if (react_feature_flags_1.enableDebugTracing) {
                    if (sourceFiber.mode & react_type_of_mode_1.DebugTracingMode) {
    ...
    if ((0, react_fiber_hydration_is_hydrating_1.isHydrating)() && sourceFiber.mode & react_type_of_mode_1.ConcurrentMode) {
        ...
        if (suspenseBoundary !== null) {
            if ((suspenseBoundary.flags & react_fiber_flags_1.ShouldCapture) === react_fiber_flags_1.NoFlags) {
                // Set a flag to indicate that we should try rendering the normal
                // children again, not the fallback.
                suspenseBoundary.flags |= react_fiber_flags_1.ForceClientRender;
            }
    ...
    do {
        switch (workInProgress.tag) {
            ...
            case react_work_tags_1.ClassComponent:
                ...
                if ((workInProgress.flags & react_fiber_flags_1.DidCapture) === react_fiber_flags_1.NoFlags && (typeof ctor.getDerivedStateFromError === "function" || instance !== null && typeof instance.componentDidCatch === "function" && !(0, react_fiber_work_legacy_error_boundary_1.isAlreadyFailedLegacyErrorBoundary)(instance))) {
                    workInProgress.flags |= react_fiber_flags_1.ShouldCapture;
                    var lane = (0, react_fiber_lane_1.pickArbitraryLane)(rootRenderLanes);
                    workInProgress.lanes = (0, react_fiber_lane_1.mergeLanes)(workInProgress.lanes, lane);
