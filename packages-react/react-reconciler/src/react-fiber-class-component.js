    ...
    enqueueSetState: function (inst, payload, callback) {
        ...
        if (__DEV__) {
            if (react_feature_flags_1.enableDebugTracing) {
                if (fiber.mode & react_type_of_mode_1.DebugTracingMode) {
...
function mountClassInstance(workInProgress, ctor, newProps, renderLanes) {
    ...
    if (typeof instance.componentDidMount === "function") {
        workInProgress.flags |= react_fiber_flags_1.Update | react_fiber_flags_1.LayoutStatic;
    }
    if (__DEV__ && (workInProgress.mode & react_type_of_mode_1.StrictEffectsMode) !== react_type_of_mode_1.NoMode) {
        workInProgress.flags |= react_fiber_flags_1.MountLayoutDev;
    }
}
