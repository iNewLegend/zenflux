...
//         ReactFiberHooksCurrent.renderingFiber.flags |= PassiveEffect;
//         pushEffect( HookHasEffect | HookPassive, formStateActionEffect.bind( null, actionQueue, action ), createEffectInstance(), null );
//     }
//
...
permalink) {
    ...
    if (action !== prevAction) {
        react_fiber_hooks_shared_1.ReactFiberHooksCurrent.renderingFiber.flags |= react_fiber_flags_1.Passive;
        (0, react_fiber_hooks_use_effect_1.pushEffect)(react_hook_effect_tags_1.HasEffect | react_hook_effect_tags_1.Passive, formStateActionEffect.bind(null, actionQueue, action), (0, react_fiber_hooks_use_effect_1.createEffectInstance)(), null);
    }
    return [state, dispatch];
}
