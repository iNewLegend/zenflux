...
function flushSync(fn) {
    ...
    if ((0, react_fiber_work_passive_effects_1.hasRootWithPendingPassiveEffects)() && (0, react_fiber_work_passive_effects_1.getRootWithPendingPassiveEffectsSafe)().tag === react_root_tags_1.LegacyRoot && (0, react_fiber_work_excution_context_1.isExecutionContextRenderOrCommitActivate)()) {
