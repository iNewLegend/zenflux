...
function handleThrow(root, thrownValue) {
    ...
    if (thrownValue === react_fiber_thenable_1.SuspenseException) {
        ...
        (0, react_fiber_work_in_progress_1.setWorkInProgressSuspendedReason)((0, react_fiber_work_loop_should_on_previous_screen_1.shouldRemainOnPreviousScreen)() && // Check if there are other pending updates that might possibly unblock this
            ...
            !(0, react_fiber_lane_constants_1.includesNonIdleWork)((0, react_fiber_work_in_progress_1.getWorkInProgressRootSkippedLanes)()) &&
            !(0, react_fiber_lane_constants_1.includesNonIdleWork)((0, react_fiber_work_in_progress_1.getWorkInProgressRootInterleavedUpdatedLanes)()) ? // Suspend work loop until data resolves
    ...
    if (react_feature_flags_1.enableProfilerTimer && erroredWork.mode & react_type_of_mode_1.ProfileMode) {
