...
function dispatchReducerAction(fiber, queue, action) {
    ...
    var update = {
        lane: lane,
        revertLane: react_fiber_lane_constants_1.NoLane,
        action: action,
        hasEagerState: false,
        eagerState: null,
        next: null
...
function updateReducerImpl(hook, current, reducer) {
    ...
    if (baseQueue !== null) {
        ...
        do {
            ...
            var shouldSkipUpdate = isHiddenUpdate ? !(0, react_fiber_lane_1.isSubsetOfLanes)((0, react_fiber_work_in_progress_1.getWorkInProgressRootRenderLanes)(), updateLane) : !(0, react_fiber_lane_1.isSubsetOfLanes)(react_fiber_hooks_shared_1.ReactFiberHooksCurrent.renderLanes, updateLane);
            if (shouldSkipUpdate) {
                ...
                if (!react_feature_flags_1.enableAsyncActions || revertLane === react_fiber_lane_constants_1.NoLane) {
    ...
    if (baseQueue === null) {
        ...
        queue.lanes = react_fiber_lane_constants_1.NoLanes;
    }
    var dispatch = queue.dispatch;
    return [hook.memoizedState, dispatch];
}
