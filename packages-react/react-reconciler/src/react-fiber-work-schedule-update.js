...
function warnIfUpdatesNotWrappedWithActDEV(fiber) {
    if (__DEV__) {
        if (fiber.mode & react_type_of_mode_1.ConcurrentMode) {
            ...
            if (fiber.tag !== react_work_tags_1.FunctionComponent && fiber.tag !== react_work_tags_1.ForwardRef && fiber.tag !== react_work_tags_1.SimpleMemoComponent) {
...
function scheduleUpdateOnFiber(root, fiber, lane) {
    ...
    if ((0, react_fiber_work_excution_context_1.isExecutionContextCommitDeactivate)() && root === (0, react_fiber_work_in_progress_1.getWorkInProgressRoot)()) {
        ...
        if (react_feature_flags_1.enableProfilerTimer && react_feature_flags_1.enableProfilerNestedUpdateScheduledHook) {
            if ((0, react_fiber_work_excution_context_1.isExecutionContextCommitDeactivate)() && (0, react_fiber_work_root_commiting_muation_or_layout_effects_1.isRootCommittingMutationOrLayoutEffects)(root)) {
                if (fiber.mode & react_type_of_mode_1.ProfileMode) {
                    var current = fiber;
                    while (current !== null) {
                        if (current.tag === react_work_tags_1.Profiler) {
        ...
        if (lane === react_fiber_lane_constants_1.SyncLane && (0, react_fiber_work_excution_context_1.isExecutionContextEmpty)() && (fiber.mode & react_type_of_mode_1.ConcurrentMode) === react_type_of_mode_1.NoMode) {
