...
function prepareWorkInProgressFreshStack(root, lanes) {
    ...
    (0, react_fiber_work_in_progress_1.setWorkInProgressRootSkippedLanes)(react_fiber_lane_constants_1.NoLanes);
    (0, react_fiber_work_in_progress_1.setWorkInProgressRootInterleavedUpdatedLanes)(react_fiber_lane_constants_1.NoLanes);
    (0, react_fiber_work_in_progress_1.setWorkInProgressRootRenderPhaseUpdatedLanes)(react_fiber_lane_constants_1.NoLanes);
    (0, react_fiber_work_in_progress_1.setWorkInProgressRootPingedLanes)(react_fiber_lane_constants_1.NoLanes);
    (0, react_fiber_work_in_progress_1.setWorkInProgressDeferredLane)(react_fiber_lane_constants_1.NoLane);
