...
if (__DEV__) {
    var findStrictRoot_1 = function (fiber) {
        ...
        var node = fiber;
        while (node !== null) {
            if (node.mode & react_type_of_mode_1.StrictLegacyMode) {
    ...
    ReactStrictModeWarnings.recordUnsafeLifecycleWarnings = function (fiber, instance) {
        ...
        if (fiber.mode & react_type_of_mode_1.StrictLegacyMode && typeof instance.UNSAFE_componentWillMount === "function") {
        ...
        if (fiber.mode & react_type_of_mode_1.StrictLegacyMode && typeof instance.UNSAFE_componentWillReceiveProps === "function") {
        ...
        if (fiber.mode & react_type_of_mode_1.StrictLegacyMode && typeof instance.UNSAFE_componentWillUpdate === "function") {
