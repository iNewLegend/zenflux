...
import { ClassComponent, IncompleteClassComponent } from "@zenflux/react-reconciler/src/react-work-tags";
...
export function markSuspenseBoundaryShouldCapture( suspenseBoundary: Fiber, returnFiber: Fiber, sourceFiber: Fiber, root: FiberRoot, rootRenderLanes: Lanes ): Fiber | null {
