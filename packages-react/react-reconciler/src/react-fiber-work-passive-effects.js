...
var pendingPassiveEffectsLanes = react_fiber_lane_constants_1.NoLanes;
var pendingPassiveProfilerEffects = [];
var pendingPassiveEffectsRemainingLanes = react_fiber_lane_constants_1.NoLanes;
...
function flushPassiveEffectsImpl() {
    ...
    pendingPassiveEffectsLanes = react_fiber_lane_constants_1.NoLanes;
    ...
    if (react_feature_flags_1.enableProfilerTimer && react_feature_flags_1.enableProfilerCommitHooks) {
        ...
        for (var i_1 = 0; i_1 < profilerEffects.length; i_1++) {
            var fiber = profilerEffects[i_1];
...
function flushPassiveEffects() {
    ...
    if (rootWithPendingPassiveEffects !== null) {
        ...
        pendingPassiveEffectsRemainingLanes = react_fiber_lane_constants_1.NoLanes;
