...
import { HostComponent } from "@zenflux/react-reconciler/src/react-work-tags";

import type { TransitionStatus } from "@zenflux/react-reconciler/src/react-fiber-config";
import type { BasicStateAction, Hook, UpdateQueue } from "@zenflux/react-reconciler/src/react-fiber-hooks-types";
import type { Lanes } from "@zenflux/react-reconciler/src/react-fiber-lane-constants";
import type { Dispatcher, Fiber, HookType } from "@zenflux/react-reconciler/src/react-internal-types";
...
export function startHostTransition<F>( formFiber: Fiber, pendingState: TransitionStatus, callback: ( arg0: F ) => unknown, formData: F ): void {
    ...
    let queue: UpdateQueue<Thenable<TransitionStatus> | TransitionStatus, BasicStateAction<Thenable<TransitionStatus> | TransitionStatus>>;
    ...
    if ( formFiber.memoizedState === null ) {
        ...
        const newQueue: UpdateQueue<Thenable<TransitionStatus> | TransitionStatus, BasicStateAction<Thenable<TransitionStatus> | TransitionStatus>> = {
            pending: null,
            lanes: NoLanes,
