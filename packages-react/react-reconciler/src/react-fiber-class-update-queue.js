...
function entangleTransitions(root, fiber, lane) {
    ...
    var sharedQueue = updateQueue.shared;
    if ((0, react_fiber_lane_constants_1.isTransitionLane)(lane)) {
...
function getStateFromUpdate(workInProgress, queue, update, prevState, nextProps, instance) {
    switch (update.tag) {
        ...
        case exports.CaptureUpdate: {
            workInProgress.flags = workInProgress.flags & ~react_fiber_flags_1.ShouldCapture | react_fiber_flags_1.DidCapture;
        }
...
function processUpdateQueue(workInProgress, props, instance, renderLanes) {
    ...
    if (firstBaseUpdate !== null) {
        ...
        var newLanes = react_fiber_lane_constants_1.NoLanes;
        ...
        do {
            ...
            var updateLane = (0, react_fiber_lane_1.removeLanes)(update.lane, react_fiber_lane_constants_1.OffscreenLane);
            ...
            if (shouldSkipUpdate) {
                ...
                if (callback !== null) {
                    workInProgress.flags |= react_fiber_flags_1.Callback;
                    if (isHiddenUpdate) {
        ...
        if (firstBaseUpdate === null) {
            ...
            queue.shared.lanes = react_fiber_lane_constants_1.NoLanes;
        }
...
function commitHiddenCallbacks(updateQueue, context) {
    ...
    if (hiddenCallbacks !== null) {
        ...
        for (var i_1 = 0; i_1 < hiddenCallbacks.length; i_1++) {
            var callback = hiddenCallbacks[i_1];
...
function commitCallbacks(updateQueue, context) {
    ...
    if (callbacks !== null) {
        ...
        for (var i_2 = 0; i_2 < callbacks.length; i_2++) {
            var callback = callbacks[i_2];
            callCallback(callback, context);
        }
    }
}
