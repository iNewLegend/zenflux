    ...
    if (__DEV__) {
        ...
        switch (fiber.tag) {
            ...
            case react_work_tags_1.SimpleMemoComponent: {
                try {
                    (0, react_fiber_commit_hook_effect_1.commitHookEffectListMount)(react_hook_effect_tags_1.Layout | react_hook_effect_tags_1.HasEffect, fiber);
                }
                catch (error) {
...
function invokePassiveEffectMountInDEV(fiber) {
    if (__DEV__) {
        ...
        switch (fiber.tag) {
            ...
            case react_work_tags_1.SimpleMemoComponent: {
                try {
                    (0, react_fiber_commit_hook_effect_1.commitHookEffectListMount)(react_hook_effect_tags_1.Passive | react_hook_effect_tags_1.HasEffect, fiber);
                }
                catch (error) {
                    (0, react_fiber_commit_phase_error_1.captureCommitPhaseError)(fiber, fiber.return, error);
                }
...
function invokeLayoutEffectUnmountInDEV(fiber) {
    if (__DEV__) {
        ...
        switch (fiber.tag) {
            ...
            case react_work_tags_1.SimpleMemoComponent: {
                try {
                    (0, react_fiber_commit_hook_effect_1.commitHookEffectListUnmount)(react_hook_effect_tags_1.Layout | react_hook_effect_tags_1.HasEffect, fiber, fiber.return);
                }
                catch (error) {
                    (0, react_fiber_commit_phase_error_1.captureCommitPhaseError)(fiber, fiber.return, error);
                }
...
function invokePassiveEffectUnmountInDEV(fiber) {
    if (__DEV__) {
        ...
        switch (fiber.tag) {
            ...
            case react_work_tags_1.SimpleMemoComponent: {
                try {
                    (0, react_fiber_commit_hook_effect_1.commitHookEffectListUnmount)(react_hook_effect_tags_1.Passive | react_hook_effect_tags_1.HasEffect, fiber, fiber.return);
                }
                catch (error) {
                    (0, react_fiber_commit_phase_error_1.captureCommitPhaseError)(fiber, fiber.return, error);
                }
...
function hideOrUnhideAllChildren(finishedWork, isHidden) {
    ...
    if (supportsMutation) {
        ...
        while (true) {
            if (node.tag === react_work_tags_1.HostComponent || (react_feature_flags_1.enableFloat && supportsResources ? node.tag === react_work_tags_1.HostHoistable : false) || (react_feature_flags_1.enableHostSingletons && supportsSingletons ? node.tag === react_work_tags_1.HostSingleton : false)) {
            ...
            else if ((node.tag === react_work_tags_1.OffscreenComponent || node.tag === react_work_tags_1.LegacyHiddenComponent) && node.memoizedState !== null && node !== finishedWork) { // Found a nested Offscreen component that is hidden.
...
function resolveRetryWakeable(boundaryFiber, wakeable) {
    var retryLane = react_fiber_lane_constants_1.NoLane; // Default
    var retryCache;
...
function recursivelyTraverseMutationEffects(root, parentFiber, lanes) {
    ...
    if (deletions !== null) {
        for (var i_1 = 0; i_1 < deletions.length; i_1++) {
            var childToDelete = deletions[i_1];
            try {
    ...
    if (parentFiber.subtreeFlags & react_fiber_flags_1.MutationMask) {
...
function commitDeletionEffectsOnFiber(finishedRoot, nearestMountedAncestor, deletedFiber) {
    ...
    switch (deletedFiber.tag) {
                    ...
                    if (lastEffect !== null) {
                        ...
                        do {
                            ...
                            if (destroy !== undefined) {
                                if ((tag & react_hook_effect_tags_1.Insertion) !== react_hook_effect_tags_1.NoFlags) {
                                    inst.destroy = undefined;
                                    (0, react_fiber_commit_phase_error_1.safelyCallDestroy)(deletedFiber, nearestMountedAncestor, destroy);
                                }
                                else if ((tag & react_hook_effect_tags_1.Layout) !== react_hook_effect_tags_1.NoFlags) {
        ...
        case react_work_tags_1.OffscreenComponent: {
            safelyDetachRef(deletedFiber, nearestMountedAncestor);
            if (deletedFiber.mode & react_type_of_mode_1.ConcurrentMode) {
...
function commitMutationEffectsOnFiber(finishedWork, root, lanes) {
    ...
    switch (finishedWork.tag) {
        ...
        case react_work_tags_1.SimpleMemoComponent: {
            ...
            if (flags & react_fiber_flags_1.Update) {
                try {
                    (0, react_fiber_commit_hook_effect_1.commitHookEffectListUnmount)(react_hook_effect_tags_1.Insertion | react_hook_effect_tags_1.HasEffect, finishedWork, finishedWork.return);
                    (0, react_fiber_commit_hook_effect_1.commitHookEffectListMount)(react_hook_effect_tags_1.Insertion | react_hook_effect_tags_1.HasEffect, finishedWork);
                }
                catch (error) {
                    (0, react_fiber_commit_phase_error_1.captureCommitPhaseError)(finishedWork, finishedWork.return, error);
                }
                ...
                if ((0, react_fiber_commit_work_1.shouldProfile)(finishedWork)) {
                    try {
                        (0, react_profile_timer_1.startLayoutEffectTimer)();
                        (0, react_fiber_commit_hook_effect_1.commitHookEffectListUnmount)(react_hook_effect_tags_1.Layout | react_hook_effect_tags_1.HasEffect, finishedWork, finishedWork.return);
                    }
                    catch (error) {
                        (0, react_fiber_commit_phase_error_1.captureCommitPhaseError)(finishedWork, finishedWork.return, error);
                    }
        ...
        case react_work_tags_1.ClassComponent: {
            recursivelyTraverseMutationEffects(root, finishedWork, lanes);
            commitReconciliationEffects(finishedWork);
            if (flags & react_fiber_flags_1.Ref) {
                if (current !== null) {
                    safelyDetachRef(current, current.return);
                }
            }
            if (flags & react_fiber_flags_1.Callback && offscreenSubtreeIsHidden) {
                var updateQueue = finishedWork.updateQueue;
                if (updateQueue !== null) {
        ...
        case react_work_tags_1.HostComponent: {
            ...
            if (supportsMutation) {
                ...
                if (finishedWork.flags & react_fiber_flags_1.ContentReset) {
                    var instance = finishedWork.stateNode;
                    try {
        ...
        case react_work_tags_1.SuspenseComponent: {
            ...
            if (offscreenFiber.flags & react_fiber_flags_1.Visibility) {
        ...
        case react_work_tags_1.OffscreenComponent: {
            ...
            if (finishedWork.mode & react_type_of_mode_1.ConcurrentMode) {
            ...
            offscreenInstance._visibility &= ~react_fiber_activity_component_1.OffscreenDetached;
            offscreenInstance._visibility |= offscreenInstance._pendingVisibility & react_fiber_activity_component_1.OffscreenDetached;
            if (flags & react_fiber_flags_1.Visibility) {
                // Track the current state on the Offscreen instance so we can
                // read it during an event
                if (isHidden) {
                    offscreenInstance._visibility &= ~react_fiber_activity_component_1.OffscreenVisible;
                }
                else {
                    offscreenInstance._visibility |= react_fiber_activity_component_1.OffscreenVisible;
                }
                if (isHidden) {
                    ...
                    if (isUpdate && !wasHidden && !wasHiddenByAncestorOffscreen) {
                        if ((finishedWork.mode & react_type_of_mode_1.ConcurrentMode) !== react_type_of_mode_1.NoMode) {
...
function commitBeforeMutationEffects_begin() {
    while ((0, react_fiber_commit_next_effect_1.hasNextEffect)()) {
        ...
        if (react_feature_flags_1.enableCreateEventHandleAPI) {
            ...
            if (deletions !== null) {
                for (var i_2 = 0; i_2 < deletions.length; i_2++) {
                    var deletion = deletions[i_2];
                    commitBeforeMutationEffectsDeletion(deletion);
                }
            }
        }
        var child = fiber.child;
        if ((fiber.subtreeFlags & react_fiber_flags_1.BeforeMutationMask) !== react_fiber_flags_1.NoFlags && child !== null) {
            child.return = fiber;
...
function commitBeforeMutationEffectsOnFiber(finishedWork) {
    ...
    if (react_feature_flags_1.enableCreateEventHandleAPI) {
        if (!shouldFireAfterActiveInstanceBlur && focusedInstanceHandle !== null) {
            ...
            if (finishedWork.tag === react_work_tags_1.SuspenseComponent && (0, react_fiber_commit_work_1.isSuspenseBoundaryBeingHidden)(current, finishedWork) && // $FlowFixMe[incompatible-call] found when upgrading Flow
    ...
    if ((flags & react_fiber_flags_1.Snapshot) !== react_fiber_flags_1.NoFlags) {
        (0, react_current_fiber_1.setCurrentFiber)(finishedWork);
    }
    switch (finishedWork.tag) {
        case react_work_tags_1.FunctionComponent: {
            if (react_feature_flags_1.enableUseEffectEventHook) {
                if ((flags & react_fiber_flags_1.Update) !== react_fiber_flags_1.NoFlags) {
...
function commitLayoutEffectOnFiber(finishedRoot, current, finishedWork, committedLanes) {
    ...
    switch (finishedWork.tag) {
        ...
        case react_work_tags_1.SimpleMemoComponent: {
            ...
            if (flags & react_fiber_flags_1.Update) {
                commitHookLayoutEffects(finishedWork, react_hook_effect_tags_1.Layout | react_hook_effect_tags_1.HasEffect);
            }
            break;
        }
        case react_work_tags_1.ClassComponent: {
            ...
            if (flags & react_fiber_flags_1.Callback) {
        ...
        case react_work_tags_1.HostComponent: {
            ...
            if (current === null && flags & react_fiber_flags_1.Update) {
        ...
        case react_work_tags_1.OffscreenComponent: {
            var isModernRoot = (finishedWork.mode & react_type_of_mode_1.ConcurrentMode) !== react_type_of_mode_1.NoMode;
            if (isModernRoot) {
                ...
                if (newOffscreenSubtreeIsHidden) { // The Offscreen tree is hidden. Skip over its layout effects.
                    ...
                    if (offscreenSubtreeWasHidden && !prevOffscreenSubtreeWasHidden) {
                        ...
                        var includeWorkInProgressEffects = (finishedWork.subtreeFlags & react_fiber_flags_1.LayoutMask) !== react_fiber_flags_1.NoFlags;
...
function recursivelyTraverseLayoutEffects(root, parentFiber, lanes) {
    var prevDebugFiber = (0, react_current_fiber_1.getCurrentFiber)();
    if (parentFiber.subtreeFlags & react_fiber_flags_1.LayoutMask) {
        var child = parentFiber.child;
        while (child !== null) {
            (0, react_current_fiber_1.setCurrentFiber)(child);
...
function recursivelyTraverseReappearLayoutEffects(finishedRoot, parentFiber, includeWorkInProgressEffects) {
    ...
    // node was reused.
    var childShouldIncludeWorkInProgressEffects = includeWorkInProgressEffects && (parentFiber.subtreeFlags & react_fiber_flags_1.LayoutMask) !== react_fiber_flags_1.NoFlags;
    // TODO (Offscreen) Check: flags & (RefStatic | LayoutStatic)
    var prevDebugFiber = (0, react_current_fiber_1.getCurrentFiber)();
    var child = parentFiber.child;
    while (child !== null) {
...
function commitReconciliationEffects(finishedWork) {
    ...
    var flags = finishedWork.flags;
    if (flags & react_fiber_flags_1.Placement) {
        try {
        ...
        finishedWork.flags &= ~react_fiber_flags_1.Placement;
    }
    if (flags & react_fiber_flags_1.Hydrating) {
        finishedWork.flags &= ~react_fiber_flags_1.Hydrating;
    }
}
    ...
    switch (finishedWork.tag) {
        ...
        case react_work_tags_1.SimpleMemoComponent: {
            ...
            if ((0, react_fiber_commit_work_1.shouldProfile)(finishedWork)) {
                try {
                    (0, react_profile_timer_1.startLayoutEffectTimer)();
                    (0, react_fiber_commit_hook_effect_1.commitHookEffectListUnmount)(react_hook_effect_tags_1.Layout, finishedWork, finishedWork.return);
                }
                finally {
                    (0, react_profile_timer_1.recordLayoutEffectDuration)(finishedWork);
                }
...
includeWorkInProgressEffects) {
    ...
    switch (finishedWork.tag) {
        ...
        case react_work_tags_1.SimpleMemoComponent: {
            ...
            commitHookLayoutEffects(finishedWork, react_hook_effect_tags_1.Layout);
            break;
        }
        case react_work_tags_1.ClassComponent: {
            recursivelyTraverseReappearLayoutEffects(finishedRoot, finishedWork, includeWorkInProgressEffects);
            ...
            if (includeWorkInProgressEffects && flags & react_fiber_flags_1.Callback) {
                commitClassCallbacks(finishedWork);
            }
        ...
        case react_work_tags_1.HostComponent: {
            ...
            // These effects should only be committed when components are first mounted,
            // aka when there is no current/alternate.
            if (includeWorkInProgressEffects && current === null && flags & react_fiber_flags_1.Update) {
                commitHostComponentMount(finishedWork);
            }
        ...
        case react_work_tags_1.Profiler: {
            ...
            if (includeWorkInProgressEffects && flags & react_fiber_flags_1.Update) {
                commitProfilerUpdate(finishedWork, current);
            }
            break;
        }
