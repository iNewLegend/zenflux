...
if (__DEV__ && react_feature_flags_1.replayFailedUnitOfWorkWithInvokeGuardedCallback) {
    ...
    beginWork = function (current, unitOfWork, lanes) {
        ...
        try {
            ...
            if ((0, react_fiber_hydration_did_suspend_on_error_1.didSuspendOrErrorWhileHydratingDEV)() || originalError === react_fiber_thenable_1.SuspenseException || originalError === react_fiber_work_selective_hydration_exception_1.SelectiveHydrationException || originalError !== null && typeof originalError === "object" && typeof originalError.then === "function") {
            ...
            if (react_feature_flags_1.enableProfilerTimer && unitOfWork.mode & react_type_of_mode_1.ProfileMode) {
...
function throwAndUnwindWorkLoop(unitOfWork, thrownValue) {
    ...
    if (unitOfWork.flags & react_fiber_flags_1.Incomplete) {
...
function completeUnitOfWork(unitOfWork) {
    ...
    do {
        if (__DEV__) {
            if ((completedWork.flags & react_fiber_flags_1.Incomplete) !== react_fiber_flags_1.NoFlags) {
...
function unwindUnitOfWork(unitOfWork) {
    ...
    do {
        ...
        if (next !== null) {
            ...
            // from the effect tag.
            next.flags &= react_fiber_flags_1.HostEffectMask;
            (0, react_fiber_work_in_progress_1.setWorkInProgress)(next);
            return;
        }
        // Keep unwinding until we reach either a boundary or the root.
        if (react_feature_flags_1.enableProfilerTimer && (incompleteWork.mode & react_type_of_mode_1.ProfileMode) !== react_type_of_mode_1.NoMode) {
        ...
        if (returnFiber !== null) {
            ...
            returnFiber.flags |= react_fiber_flags_1.Incomplete;
            returnFiber.subtreeFlags = react_fiber_flags_1.NoFlags;
...
function performUnitOfWork(unitOfWork) {
    ...
    var next;
    if (react_feature_flags_1.enableProfilerTimer && (unitOfWork.mode & react_type_of_mode_1.ProfileMode) !== react_type_of_mode_1.NoMode) {
        (0, react_profile_timer_1.startProfilerTimer)(unitOfWork);
...
function replaySuspendedUnitOfWork(unitOfWork) {
    ...
    var next;
    (0, react_current_fiber_1.setCurrentFiber)(unitOfWork);
    var isProfilingMode = react_feature_flags_1.enableProfilerTimer && (unitOfWork.mode & react_type_of_mode_1.ProfileMode) !== react_type_of_mode_1.NoMode;
    if (isProfilingMode) {
        (0, react_profile_timer_1.startProfilerTimer)(unitOfWork);
    }
    switch (unitOfWork.tag) {
        case react_work_tags_1.IndeterminateComponent: {
            ...
            // function component.
            unitOfWork.tag = react_work_tags_1.FunctionComponent; // Fallthrough to the next branch.
        }
