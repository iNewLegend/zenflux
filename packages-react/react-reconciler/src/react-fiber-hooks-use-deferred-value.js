...
function mountDeferredValueImpl(hook, value, initialValue) {
    if (react_feature_flags_1.enableUseDeferredValueInitialArg && // When `initialValue` is provided, we defer the initial render even if the
        ...
        !(0, react_fiber_lane_1.includesSomeLane)(react_fiber_hooks_shared_1.ReactFiberHooksCurrent.renderLanes, react_fiber_lane_constants_1.DeferredLane)) {
...
function updateDeferredValueImpl(hook, prevValue, value, initialValue) {
    if ((0, object_is_1.default)(value, prevValue)) {
        ...
        var shouldDeferValue = !(0, react_fiber_lane_constants_1.includesOnlyNonUrgentLanes)(react_fiber_hooks_shared_1.ReactFiberHooksCurrent.renderLanes);
        if (shouldDeferValue) {
