...
function finishConcurrentRender(root, exitStatus, finishedWork, lanes) {
    ...
    switch (exitStatus) {
        ...
        case root_exit_status_1.RootExitStatus.RootSuspendedWithDelay: {
            if ((0, react_fiber_lane_constants_1.includesOnlyTransitions)(lanes)) {
    ...
    if (shouldForceFlushFallbacksInDEV()) {
        ...
        if ((0, react_fiber_lane_constants_1.includesOnlyRetries)(lanes) && (react_feature_flags_1.alwaysThrottleRetries || exitStatus === root_exit_status_1.RootExitStatus.RootSuspended)) {
            ...
            if (msUntilTimeout > 10) {
                (0, react_fiber_lane_mark_root_1.markRootSuspended)(root, lanes, (0, react_fiber_work_in_progress_1.getWorkInProgressDeferredLane)());
                var nextLanes = (0, react_fiber_lane_1.getNextLanes)(root, react_fiber_lane_constants_1.NoLanes);
...
function performConcurrentWorkOnRoot(root, didTimeout) {
    ...
    var lanes = (0, react_fiber_lane_1.getNextLanes)(root, root === (0, react_fiber_work_in_progress_1.getWorkInProgressRoot)() ? (0, react_fiber_work_in_progress_1.getWorkInProgressRootRenderLanes)() : react_fiber_lane_constants_1.NoLanes);
    ...
    var shouldTimeSlice = !(0, react_fiber_lane_constants_1.includesBlockingLane)(root, lanes) && !(0, react_fiber_lane_constants_1.includesExpiredLane)(root, lanes) && (react_feature_flags_1.disableSchedulerTimeoutInWorkLoop || !didTimeout);
    var exitStatus = shouldTimeSlice ? renderRootConcurrent(root, lanes) : (0, react_fiber_work_on_root_render_root_1.renderRootSync)(root, lanes);
    if (exitStatus !== root_exit_status_1.RootExitStatus.RootInProgress) {
        ...
        do {
            if (exitStatus === root_exit_status_1.RootExitStatus.RootDidNotComplete) {
                ...
                (0, react_fiber_lane_mark_root_1.markRootSuspended)(root, lanes, react_fiber_lane_constants_1.NoLane);
            }
            else {
                ...
                if (exitStatus === root_exit_status_1.RootExitStatus.RootErrored) {
                    ...
                    if (errorRetryLanes !== react_fiber_lane_constants_1.NoLanes) {
                ...
                if (exitStatus === root_exit_status_1.RootExitStatus.RootFatalErrored) {
                    ...
                    (0, react_fiber_work_in_progress_prepare_fresh_stack_1.prepareWorkInProgressFreshStack)(root, react_fiber_lane_constants_1.NoLanes);
                    (0, react_fiber_lane_mark_root_1.markRootSuspended)(root, lanes, react_fiber_lane_constants_1.NoLane);
