...
if ( __DEV__ ) {
    const findStrictRoot = ( fiber: Fiber ): Fiber | null => {
        let maybeStrictRoot: null | Fiber = null;
    ...
    ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = () => {
        ...
        if ( pendingComponentWillMountWarnings.length > 0 ) {
            pendingComponentWillMountWarnings.forEach( fiber => {
                componentWillMountUniqueNames.add( reactGetComponentNameFromFiber( fiber ) || "Component" );
        ...
        if ( pendingUNSAFE_ComponentWillMountWarnings.length > 0 ) {
            pendingUNSAFE_ComponentWillMountWarnings.forEach( fiber => {
                UNSAFE_componentWillMountUniqueNames.add( reactGetComponentNameFromFiber( fiber ) || "Component" );
                didWarnAboutUnsafeLifecycles.add( fiber.type );
            } );
        ...
        if ( pendingComponentWillReceivePropsWarnings.length > 0 ) {
            pendingComponentWillReceivePropsWarnings.forEach( fiber => {
                componentWillReceivePropsUniqueNames.add( reactGetComponentNameFromFiber( fiber ) || "Component" );
                didWarnAboutUnsafeLifecycles.add( fiber.type );
            } );
        ...
        if ( pendingUNSAFE_ComponentWillReceivePropsWarnings.length > 0 ) {
            pendingUNSAFE_ComponentWillReceivePropsWarnings.forEach( fiber => {
                UNSAFE_componentWillReceivePropsUniqueNames.add( reactGetComponentNameFromFiber( fiber ) || "Component" );
                didWarnAboutUnsafeLifecycles.add( fiber.type );
            } );
        ...
        if ( pendingComponentWillUpdateWarnings.length > 0 ) {
            pendingComponentWillUpdateWarnings.forEach( fiber => {
                componentWillUpdateUniqueNames.add( reactGetComponentNameFromFiber( fiber ) || "Component" );
                didWarnAboutUnsafeLifecycles.add( fiber.type );
            } );
        ...
        if ( pendingUNSAFE_ComponentWillUpdateWarnings.length > 0 ) {
            pendingUNSAFE_ComponentWillUpdateWarnings.forEach( fiber => {
                UNSAFE_componentWillUpdateUniqueNames.add( reactGetComponentNameFromFiber( fiber ) || "Component" );
                didWarnAboutUnsafeLifecycles.add( fiber.type );
            } );
    ...
    ReactStrictModeWarnings.flushLegacyContextWarning = () => {
        ...
        ( ( pendingLegacyContextWarning as any ) as FiberToFiberComponentsMap ).forEach( ( fiberArray: FiberArray, strictRoot ) => {
            ...
            fiberArray.forEach( fiber => {
                uniqueNames.add( reactGetComponentNameFromFiber( fiber ) || "Component" );
