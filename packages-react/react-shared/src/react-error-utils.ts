 ...
 */
export function invokeGuardedCallback<Context>( name: string | null, func: ( ... args: any[] ) => any, context?: Context, ... args: any[] ): void { // eslint-disable-line @typescript-eslint/no-unused-vars
    hasError = false;
    caughtError = null;
    invokeGuardedCallbackImpl.apply( reporter, [
        name,
        func,
        context,
    ] );
