...
function describeNativeComponentFrame(fn, construct) {
    ...
    try {
        ...
        if (sample && control && typeof sample.stack === "string") {
            ...
            var s_1 = sampleLines.length - 1;
            var c = controlLines.length - 1;
            while (s_1 >= 1 && c >= 0 && sampleLines[s_1] !== controlLines[c]) {
            ...
            for (; s_1 >= 1 && c >= 0; s_1--, c--) {
                ...
                if (sampleLines[s_1] !== controlLines[c]) {
                    ...
                    if (s_1 !== 1 || c !== 1) {
                        do {
                            ...
                            if (c < 0 || sampleLines[s_1] !== controlLines[c]) {
                                // V8 adds a "new" prefix for native classes. Let's remove it to make it prettier.
                                var frame = "\n" + sampleLines[s_1].replace(" at new ", " at ");
