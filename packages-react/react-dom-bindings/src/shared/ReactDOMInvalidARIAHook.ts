...
import validAriaProperties from "@zenflux/react-dom-bindings/src/shared/validAriaProperties";
...
export function validateProperties( type: string, props: Record<string, any> ) {
    if ( __DEV__ ) {
