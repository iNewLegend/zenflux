...
import { getCrossOriginString } from "@zenflux/react-dom-bindings/src/shared/crossOriginStrings";

import type { HintCode, HintModel } from "@zenflux/react-dom-bindings/src/server/ReactFlightServerConfigDOM";

const ReactDOMCurrentDispatcher = ReactDOMSharedInternals.Dispatcher;

export function dispatchHint<Code extends HintCode>( code: Code, model: HintModel<Code> ): void {
...
function refineModel<T extends HintCode>( code: T, model: HintModel<any> ): HintModel<T> {
    return model;
}

export function preinitModuleForSSR( href: string, nonce: string | null | undefined, crossOrigin: string | null | undefined ) {
    const dispatcher = ReactDOMCurrentDispatcher.current;
...
export function preinitScriptForSSR( href: string, nonce: string | null | undefined, crossOrigin: string | null | undefined ) {
    const dispatcher = ReactDOMCurrentDispatcher.current;
