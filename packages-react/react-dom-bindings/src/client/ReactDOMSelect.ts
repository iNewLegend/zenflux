...
function checkSelectPropTypes( props: any ) {
    if ( __DEV__ ) {
        for ( let i = 0 ; i < valuePropNames.length ; i++ ) {
            ...
            const propNameIsArray = Array.isArray( props[ propName ] );
...
function updateOptions( node: HTMLSelectElement, multiple: boolean, propValue: any, setDefaultSelected: boolean ) {
    ...
    if ( multiple ) {
        ...
        let defaultSelected: HTMLOptionElement | null = null;
 ...
 * selected.
 */
export function validateSelectProps( element: Element, props: Record<string, any> ) {
    if ( __DEV__ ) {
...
export function initSelect( element: Element, value: string | null | undefined, defaultValue: string | null | undefined, multiple: boolean | null | undefined ) {
...
export function updateSelect( element: Element, value: string | null | undefined, defaultValue: string | null | undefined, multiple: boolean | null | undefined, wasMultiple: boolean | null | undefined ) {
    const node: HTMLSelectElement = ( element as any );
...
export function restoreControlledSelectState( element: Element, props: Record<string, any> ) {
    const node: HTMLSelectElement = ( element as any );
