...
export function updateTextarea( element: Element, value: string | null | undefined, defaultValue: string | null | undefined ) {
...
export function initTextarea( element: Element, value: string | null | undefined, defaultValue: string | null | undefined, children: string | null | undefined ) {
    const node: HTMLTextAreaElement = ( element as any );
