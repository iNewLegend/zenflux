...
var STYLE = "style";
exports.HostContextNamespaceNone = 0;
    ...
    switch (nodeType) {
        ...
        case HTMLNodeType_1.DOCUMENT_FRAGMENT_NODE: {
            ...
            if (root) {
                ...
                context = namespaceURI ? getOwnHostContext(namespaceURI) : exports.HostContextNamespaceNone;
            }
            else {
                context = exports.HostContextNamespaceNone;
            }
            break;
        }
        default: {
...
function getOwnHostContext(namespaceURI) {
    switch (namespaceURI) {
        ...
        default:
            return exports.HostContextNamespaceNone;
    }
}
function getChildHostContextProd(parentNamespace, type) {
    if (parentNamespace === exports.HostContextNamespaceNone) {
...
function prepareForCommit(containerInfo) {
    eventsEnabled = (0, ReactDOMEventListener_1.isEnabled)();
...
function resetAfterCommit(containerInfo) {
    ...
    (0, ReactDOMEventListener_1.setEnabled)(eventsEnabled);
    eventsEnabled = null;
...
function getCurrentEventPriority() {
    ...
    return (0, ReactDOMEventListener_1.getEventPriority)(currentEvent.type);
}
...
function getNextHydratable(node) {
    ...
    for (; node != null; node = node.nextSibling) {
        ...
        if (nodeType === HTMLNodeType_1.COMMENT_NODE) {
            ...
            if (nodeData === SUSPENSE_START_DATA || nodeData === SUSPENSE_FALLBACK_START_DATA || nodeData === SUSPENSE_PENDING_START_DATA || react_feature_flags_1.enableFormActions && react_feature_flags_1.enableAsyncActions && (nodeData === FORM_STATE_IS_MATCHING || nodeData === FORM_STATE_IS_NOT_MATCHING)) {
                break;
            }
...
function hydrateInstance(instance, type, props, hostContext, internalInstanceHandle /* Object */, shouldWarnDev) {
    ...
    var isConcurrentMode = (internalInstanceHandle.mode & react_type_of_mode_1.ConcurrentMode) !== react_type_of_mode_1.NoMode;
...
function isHiddenSubtree(fiber) {
    return fiber.tag === react_work_tags_1.HostComponent && fiber.memoizedProps.hidden === true;
}
...
function hydrateHoistable(hoistableRoot, type, props, internalInstanceHandle /* Object */) {
    ...
    getInstance: switch (type) {
        ...
        case "meta": {
            ...
            if (maybeNodes) {
                var nodes = maybeNodes;
                for (var i_4 = 0; i_4 < nodes.length; i_4++) {
                    var node = nodes[i_4];
...
function getHydratableHoistableCache(type, keyAttribute, ownerDocument) {
    ...
    for (var i_5 = 0; i_5 < nodes.length; i_5++) {
        var node = nodes[i_5];
...
function insertStylesheetIntoRoot(root, resource, map) {
    ...
    if (!precedences) {
        ...
        for (var i_6 = 0; i_6 < nodes.length; i_6++) {
            var node = nodes[i_6];
