...
exports.setDefaultValue = exports.restoreControlledInputState = exports.initInput = exports.updateInput = exports.validateInputProps = void 0;
...
exports.validateInputProps = validateInputProps;
function updateInput(element, value, defaultValue, lastDefaultValue, checked, defaultChecked, type, name) {
    ...
    if (type != null && typeof type !== "function" && typeof type !== "symbol" && typeof type !== "boolean") {
        if (__DEV__) {
            (0, check_string_coercion_1.checkAttributeStringCoercion)(type, "type");
        }
        node.type = type;
    }
    else {
    ...
    if (value != null) {
        if (type === "number") {
            ...
            value === 0 && node.value === "" || // We explicitly want to coerce to number here if possible.
                ...
                node.value != value) {
                node.value = (0, ToStringValue_1.toString)((0, ToStringValue_1.getToStringValue)(value));
            }
        }
        else if (node.value !== (0, ToStringValue_1.toString)((0, ToStringValue_1.getToStringValue)(value))) {
            node.value = (0, ToStringValue_1.toString)((0, ToStringValue_1.getToStringValue)(value));
        }
    }
    ...
    if (react_feature_flags_1.disableInputAttributeSyncing) {
        ...
        if (defaultValue != null) {
            setDefaultValue(node, type, (0, ToStringValue_1.getToStringValue)(defaultValue));
        }
        ...
        if (value != null) {
            setDefaultValue(node, type, (0, ToStringValue_1.getToStringValue)(value));
        }
    ...
    if (name != null && typeof name !== "function" && typeof name !== "symbol" && typeof name !== "boolean") {
        if (__DEV__) {
            (0, check_string_coercion_1.checkAttributeStringCoercion)(name, "name");
        }
        node.name = (0, ToStringValue_1.toString)((0, ToStringValue_1.getToStringValue)(name));
    }
    else {
...
function initInput(element, value, defaultValue, checked, defaultChecked, type, name, isHydrating) {
    ...
    if (value != null || defaultValue != null) {
        ...
        var defaultValueStr = defaultValue != null ? (0, ToStringValue_1.toString)((0, ToStringValue_1.getToStringValue)(defaultValue)) : "";
        var initialValue = value != null ? (0, ToStringValue_1.toString)((0, ToStringValue_1.getToStringValue)(value)) : defaultValueStr;
        ...
        if (!isHydrating) {
            if (react_feature_flags_1.disableInputAttributeSyncing) {
                ...
                if (value != null) {
                    ...
                    // empty string.
                    if (isButton || (0, ToStringValue_1.toString)((0, ToStringValue_1.getToStringValue)(value)) !== node.value) {
                        node.value = (0, ToStringValue_1.toString)((0, ToStringValue_1.getToStringValue)(value));
                    }
                }
            }
...
function restoreControlledInputState(element, props) {
    ...
    if (props.type === "radio" && name != null) {
        ...
        var group = queryRoot.querySelectorAll("input[name=\"" + (0, escapeSelectorAttributeValueInsideDoubleQuotes_1.default)("" + name) + "\"][type=\"radio\"]");
        for (var i_1 = 0; i_1 < group.length; i_1++) {
            var otherNode = group[i_1];
            ...
            var otherProps = (0, ReactDOMComponentTree_1.getFiberCurrentPropsFromNode)(otherNode);
            if (!otherProps) {
        ...
        for (var i_2 = 0; i_2 < group.length; i_2++) {
            var otherNode = group[i_2];
            if (otherNode.form !== rootNode.form) {
                continue;
            }
            (0, inputValueTracking_1.updateValueIfChanged)(otherNode);
        }
    }
}
exports.restoreControlledInputState = restoreControlledInputState;
...
function setDefaultValue(node, type, value) {
    ...
    type !== "number" || (0, getActiveElement_1.default)(node.ownerDocument) !== node) {
        if (node.defaultValue !== (0, ToStringValue_1.toString)(value)) {
            node.defaultValue = (0, ToStringValue_1.toString)(value);
        }
    }
}
