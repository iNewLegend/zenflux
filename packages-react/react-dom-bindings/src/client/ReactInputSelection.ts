...
import { getOffsets, setOffsets } from "@zenflux/react-dom-bindings/src/client/ReactDOMSelection";
import { ELEMENT_NODE, TEXT_NODE } from "@zenflux/react-dom-bindings/src/client/HTMLNodeType";
...
function getActiveElementDeep() {
    ...
    while ( element instanceof win.HTMLIFrameElement ) {
        if ( isSameOriginFrame( element ) ) {
            win = element.contentWindow as typeof window;
        } else {
            return element;
        }
