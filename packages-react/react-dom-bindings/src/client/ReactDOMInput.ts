...
import { disableInputAttributeSyncing } from "@zenflux/react-shared/src/react-feature-flags";
...
import type { ToStringValue } from "@zenflux/react-dom-bindings/src/client/ToStringValue";
 ...
 */
export function validateInputProps( element: Element, props: Record<string, any> ) {
    if ( __DEV__ ) {
...
export function updateInput( element: Element, value: string | null | undefined | number, defaultValue: string | null | undefined, lastDefaultValue: string | null | undefined, checked: boolean | null | undefined, defaultChecked: boolean | null | undefined, type: string | null | undefined, name: string | null | undefined ) {
...
export function initInput( element: Element, value: string | null | undefined, defaultValue: string | null | undefined, checked: boolean | null | undefined, defaultChecked: boolean | null | undefined, type: string | null | undefined, name: string | null | undefined, isHydrating: boolean ) {
    const node: HTMLInputElement = ( element as any );
...
export function restoreControlledInputState( element: Element, props: Record<string, any> ) {
...
export function setDefaultValue( node: HTMLInputElement, type: string | null | undefined, value: ToStringValue ) {
