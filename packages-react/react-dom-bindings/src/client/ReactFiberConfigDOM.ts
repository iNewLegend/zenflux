...
import { HostComponent, HostHoistable, HostSingleton, HostText } from "@zenflux/react-reconciler/src/react-work-tags";
...
function getChildHostContextProd( parentNamespace: HostContextNamespace, type: string ): HostContextNamespace {
...
export function getHoistableRoot( container: Container ): HoistableRoot {
    // $FlowFixMe[method-unbinding]
    return <Document | ShadowRoot> ( typeof container.getRootNode === "function" ?
            /**
