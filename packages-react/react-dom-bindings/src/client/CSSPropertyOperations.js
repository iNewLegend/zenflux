...
function expandShorthandMap(styles) {
    ...
    for (var key in styles) {
        ...
        for (var i_1 = 0; i_1 < longhands.length; i_1++) {
            expanded[longhands[i_1]] = key;
        }
    }
    return expanded;
}
    ...
    if (__DEV__) {
        ...
        if (prevStyles) {
            for (var key in prevStyles) {
                if (prevStyles.hasOwnProperty(key) && !nextStyles.hasOwnProperty(key)) {
                    var longhands = CSSShorthandProperty_1.shorthandToLonghand[key] || [key];
                    for (var i_2 = 0; i_2 < longhands.length; i_2++) {
                        expandedUpdates[longhands[i_2]] = key;
                    }
                }
            }
        }
        for (var key in nextStyles) {
            if (nextStyles.hasOwnProperty(key) && (!prevStyles || prevStyles[key] !== nextStyles[key])) {
                var longhands = CSSShorthandProperty_1.shorthandToLonghand[key] || [key];
                for (var i_3 = 0; i_3 < longhands.length; i_3++) {
                    expandedUpdates[longhands[i_3]] = key;
                }
            }
        }
