...
function extractEvents(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags, targetContainer) {
    ...
    if (react_feature_flags_1.enableCreateEventHandleAPI && eventSystemFlags & EventSystemFlags_1.IS_EVENT_HANDLE_NON_MANAGED_NODE) {
        var listeners = (0, DOMPluginEventSystem_1.accumulateEventHandleNonManagedNodeListeners)(// TODO: this cast may not make sense for events like
        ...
        var listeners = (0, DOMPluginEventSystem_1.accumulateSinglePhaseListeners)(targetInst, reactName, nativeEvent.type, inCapturePhase, accumulateTargetOnly, nativeEvent);
        if (listeners.length > 0) {
            // Intentionally create event lazily.
