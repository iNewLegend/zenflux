...
function extractEvents(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags, targetContainer) {
    ...
    if (isOutEvent) {
        ...
        if (to !== null) {
            ...
            var tag = to.tag;
            if (to !== nearestMounted || tag !== react_work_tags_1.HostComponent && (!react_feature_flags_1.enableHostSingletons ? true : tag !== react_work_tags_1.HostSingleton) && tag !== react_work_tags_1.HostText) {
                to = null;
            }
        }
    }
    ...
    (0, DOMPluginEventSystem_1.accumulateEnterLeaveTwoPhaseListeners)(dispatchQueue, leave, enter, from, to);
}
