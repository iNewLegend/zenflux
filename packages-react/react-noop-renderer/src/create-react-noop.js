 ...
 * environment.
 */
var constants_1 = require("@zenflux/react-reconciler/constants");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    currentEventPriority = constants_1.DefaultEventPriority;
                    idCounter = 0;
                    ReactNoop = {
                        ...
                        createRoot: function (options) {
                            ...
                            // @ts-ignore
                            var fiberRoot = NoopRenderer.createContainer(container, constants_1.ConcurrentRoot, null, null, false, "", onRecoverableError, options && options.unstable_transitionCallbacks ? options.unstable_transitionCallbacks : null);
                            return {
                                _Scheduler: Scheduler,
                        ...
                        createLegacyRoot: function () {
                            ...
                            // @ts-ignore
                            var fiberRoot = NoopRenderer.createContainer(container, constants_1.LegacyRoot, null, null, false, "", onRecoverableError, null);
                            return {
                                _Scheduler: Scheduler,
                                render: function (children) {
                                    NoopRenderer.updateContainer(children, fiberRoot, null, null);
                            ...
                            if (record === undefined) {
                                ...
                                if (record.status === "pending") {
                                    ...
                                    if (subscriptions !== null) {
                                        ...
                                        for (var i_1 = 0; i_1 < subscriptions.length; i_1++) {
                                            var subscription = subscriptions[i_1];
                        ...
                        renderLegacySyncRoot: function (element, callback) {
                            ...
                            var container = ReactNoop.getOrCreateRootContainer(rootID, constants_1.LegacyRoot);
                            var root = roots.get(container.rootID);
                            // @ts-ignore
                            NoopRenderer.updateContainer(element, root, null, callback);
                        },
                        renderToRootWithID: function (element, rootID, callback) {
                            var container = ReactNoop.getOrCreateRootContainer(rootID, constants_1.ConcurrentRoot);
                            var root = roots.get(container.rootID);
                            // @ts-ignore
                            NoopRenderer.updateContainer(element, root, null, callback);
                        },
                        ...
                        idleUpdates: function (fn) {
                            ...
                            currentEventPriority = constants_1.IdleEventPriority;
                            try {
                                fn();
                            }
                            finally {
