...
import {
    ...
    IdleEventPriority,
    LegacyRoot
} from "@zenflux/react-reconciler/constants";
...
import type { PublicInstance, ReactReconcilerConfig } from "@zenflux/react-reconciler/src/react-fiber-config";

import type { Lane } from "@zenflux/react-reconciler/src/react-fiber-lane-constants";
import type { Fiber, TransitionTracingCallbacks } from "@zenflux/react-reconciler/src/react-internal-types";
...
type UpdateQueue<State> = {
    ...
    shared: SharedQueue<State, Update<State>>;
...
async function createReactNoop( reconciler: typeof reactReconciler, useMutation: boolean ) {
    ...
    const ReactNoop = {
        ...
        dumpTree( rootID: string = DEFAULT_ROOT_ID ) {
            ...
            function logUpdateQueue( updateQueue: UpdateQueue<any>, depth ) {
