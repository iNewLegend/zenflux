...
var yieldInterval = 5;
var deadline = 0;
var currentPriorityLevel_DEPRECATED = SchedulerPriorities_1.NormalPriority;
...
function unstable_scheduleCallback(priorityLevel, callback, options) {
    ...
    var controller = new /** @class */ (function (_super) {
...
function runTask(priorityLevel, postTaskPriority, node, callback) {
    ...
    try {
        ...
        currentPriorityLevel_DEPRECATED = SchedulerPriorities_1.NormalPriority;
    }
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
