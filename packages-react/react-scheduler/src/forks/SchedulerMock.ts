...
import { enableProfiling, enableSchedulerDebugging } from "@z-react-scheduler/SchedulerFeatureFlags";
...
type Callback = ( arg0: boolean ) => Callback | null | undefined;
...
let scheduledCallback: null | ( ( hasTimeRemaining: boolean, initialTime: DOMHighResTimeStamp | number ) => boolean ) = null;
...
function requestHostCallback( callback: ( arg0: boolean, arg1: number ) => boolean ) {
...
function unstable_clearLog(): Array<unknown> {
